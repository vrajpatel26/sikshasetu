...
function Nav() {
  ...
  return (
    ...
    <div className='w-[100%] h-[70px] fixed top-0 px-[20px] py-[10px] flex items-center justify-between bg-[#00000047]  z-10'>
     <div className='lg:w-[20%] w-[40%] lg:pl-[50px] flex items-center gap-5 '>
        <img src={logo} className=' w-[60px]  rounded-[5px] cursor-pointer ' onClick={()=>navigate("/")} alt="" />
        <h1 className='text-white text-3xl font-bold'>SikshaSetu</h1>
     </div>
